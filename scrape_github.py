...
# GitHub API token
GITHUB_TOKEN = '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'
...
def fetch_users(city="Stockholm", min_followers=100):
    users = []
    page = 1
